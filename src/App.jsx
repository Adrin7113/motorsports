...
function App() {
  ...
  return (
    <div className="min-h-screen max-w-screen">
      ...
      {/*First Image */}
      <div className="max-w-screen h-[800px] relative flex justify-center items-center">
        <img
      ...
      <div
        ...
        className="max-w-screen h-[800px] relative flex  p-16"
      >
        <img
      ...
      <div
        ...
        className="max-w-screen h-[800px] relative flex  p-16 justify-end"
      >
        <img
          src="/introThird.webp"
          className="w-full h-full absolute top-0 left-0"
